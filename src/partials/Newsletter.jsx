              ...
              <svg width="428" height="328" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient
                    ...
                    id="ni-a"
                  >
                    <stop stopColor="#ef7ce5" offset="0%" />
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                ...
                <p className="text-gray-300 text-lg mb-6">
                  Suscribe today to receive our newsletter packed with insights,
                  tips, and best practices to help your marketing business
                  succeed.
                </p>
                ...
                <form className="w-full lg:w-auto" onSubmit={handleSubmit}>
                  ...
                  {/* <p className="text-sm text-gray-400 mt-3">Have a great day</p> */}
                </form>
              </div>
            </div>
          </div>
