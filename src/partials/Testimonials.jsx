        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 mb-4">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-pink-400">
                Trusted{" "}
              </span>{" "}
              by over 15+ active companies all over the world.
            </h2>
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 md:grid-cols-5">
            ...
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <svg
                className="max-w-full fill-current text-yellow-400"
                width="83"
                height="30"
                viewBox="0 0 83 30"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <svg
                className="max-w-full fill-current text-blue-400"
                width="125"
                height="39"
                viewBox="0 0 125 39"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <svg
                className="max-w-full fill-current text-pink-400"
                width="113"
                height="30"
                viewBox="0 0 113 30"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ love how Mutalo is focused on creating value added creative
                  and bespoke digital solutions that efficiently drive traffic,
                  sales and leads. “
                </blockquote>
          ...
          <div className="max-w-3xl mx-auto mt-20" data-aos="zoom-y-out">
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ Mutalo is a one stop digital solutions provider. We team up
                  with a team of highly skilled designers and developers, ready
                  to help you with all your design and development needs.
                  Definetly a lifesaver. “
                </blockquote>
                <cite className="block font-bold text-lg not-italic mb-1">
                  Lucas D'Onofrio
                </cite>
